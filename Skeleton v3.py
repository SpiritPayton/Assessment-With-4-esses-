"""Same as v2 but I added comments and the print function
made by miya so-beer
"""
...
def delete():
    ...
    if delete_monster:
        ...
        easygui.msgbox("What?!!?! Baby, you never tell Auntie Heigui the name of the monster Auntie will assassinate lah.")
